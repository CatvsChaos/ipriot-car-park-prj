...
class TestCarPark(unittest.TestCase):
    def setUp(self):
        self.car_park = CarPark("123 Example Street", 100, [], [], [], log_file = Path("log.txt"))
    ...
    def test_car_logged_when_entering(self):
       self.car_park = CarPark("123 Example Street", 100, [],[],[], log_file = "new_log.txt") # TODO: change this to use a class attribute or new instance variable
